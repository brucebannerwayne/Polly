...
    public float maxPosx;
    ...
    void Update()
    {
        ...
        //if (octo.gameObject.GetComponent<Bomb>().ismoveable == true)
        //{
        //    player = GameObject.Find("octopus using");
        //}
        //if (octo.gameObject.GetComponent<Bomb>().ismoveable == false)
        //{
        //    player = GameObject.Find("Mipha");
        //}
